...
public static class EmailLayout
{
    ...
    private const string MobileStyle =
        ...
        ".ra-greet{font-size:16px!important;}" +
            ...
            <tr><td align="center" style="padding:32px 12px;">
              <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" class="ra-card" style="width:600px;max-width:600px;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
                ...
                <tr><td class="ra-pad" style="padding:14px 40px 0;">
                  <h1 class="ra-h1" style="margin:0;font-family:'Oswald',Arial,Helvetica,sans-serif;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:#101010;font-size:24px;line-height:1.15;">{title}</h1>
                ...
                <tr><td align="center" class="ra-pad" style="padding:22px 40px 32px;font-family:Verdana,Geneva,Tahoma,sans-serif;color:#9ca3af;font-size:13px;line-height:1.7;">
