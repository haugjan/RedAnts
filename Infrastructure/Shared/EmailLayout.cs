...
public static class EmailLayout
{
        ...
        string? note = null)
    {
            ...
            : $"""
              <tr><td style="padding:22px 40px 0;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f5f5f5;border-left:4px solid {Accent};border-radius:4px;">
                  <tr><td style="padding:16px 18px;font-family:Arial,Helvetica,sans-serif;color:#323232;font-size:15px;line-height:1.6;">{detailsHtml}</td></tr>
                </table>
              </td></tr>
              """;
        ...
        var noteBlock = string.IsNullOrWhiteSpace(note)
            ? ""
            : $"""<tr><td style="padding:18px 40px 0;font-family:Arial,Helvetica,sans-serif;color:#666666;font-size:14px;line-height:1.6;">{note}</td></tr>""";
            ...
            <tr><td align="center" style="padding:32px 12px;">
              <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
                ...
                <tr><td style="padding:24px 40px 0;">
                  <h1 style="margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:800;text-transform:uppercase;letter-spacing:0.5px;color:#101010;font-size:26px;line-height:1.15;">{title}</h1>
                  <div style="height:3px;width:48px;background:{Accent};margin-top:14px;"></div>
                </td></tr>
                <tr><td style="padding:18px 40px 0;font-family:Arial,Helvetica,sans-serif;color:#323232;font-size:16px;line-height:1.65;">
                  {greetingBlock}
                  <div>{bodyHtml}</div>
                </td></tr>
                {detailsBlock}
                ...
                <tr><td align="center" style="padding:22px 40px 32px;font-family:Arial,Helvetica,sans-serif;color:#9ca3af;font-size:13px;line-height:1.7;">
                  <span style="font-weight:800;text-transform:uppercase;letter-spacing:0.5px;color:#101010;font-size:15px;">{Brand}</span>
                </td></tr>
              </table>
            </td></tr>
          </table>
