...
"@
        ...
        # az sql db export nutzt den Azure Import/Export-Dienst, der sich gegen
        # master authentifiziert — Contained Database Users (WITH PASSWORD) werden
        # dort abgelehnt. redants_backup braucht daher ein Server-Level Login.
        # DEFAULT_DATABASE ist in Azure SQL Database nicht unterstützt (Msg 40517).
        $sqlBackupLogin = @"
