...
| S2 | `feature/s2-r2-inline-edit` | `C:\development\RedAnts-s2` | Inline-Edit-Fundament (zuerst!) + Spieltickets + Flextickets | **Fundament in `main` (`51fc8b8`)** — S4/S5/S6 können bauen; Spieltickets/Flextickets in Arbeit |
