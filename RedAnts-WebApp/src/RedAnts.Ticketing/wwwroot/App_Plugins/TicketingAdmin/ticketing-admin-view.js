...
// A bare custom element that embeds the Blazor admin app in an iframe, isolating it from the
// backoffice styles/DOM. The admin tabs are in-app state inside the Blazor app. Mirrors the
// Sporthalle pattern.
