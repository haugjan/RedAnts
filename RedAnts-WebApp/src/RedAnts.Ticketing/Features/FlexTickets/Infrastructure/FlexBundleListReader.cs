...
public sealed class FlexBundleListReader(IScopeProvider scopeProvider) : IFlexBundleListReader
{
    public async Task<IReadOnlyList<FlexBundleRow>> GetBySeasonAsync(int seasonId)
    {
        ...
        return bundles.Select(b =>
        {
            ...
            return new FlexBundleRow(b.Id, b.SeasonId, (TicketCategory)b.Category, b.Reference,
